  ...
  <div className="list-item">
    ...
    <div className="row">
      <div className="col-sm-6">
        <img src={images(`./${itemKey}/lg.jpg`)} className="project-img" />
      </div>
      <div className="col-sm-6">
        <img src={logos(`./${company}.jpg`)} className="logo center" />
    ...
    {live && (
      <a href={url} className="btn btn-primary btn-lg" target="_blank">
        View Live Site
      </a>
    )}
  </div>
