// Tailored ATS resume content for the GC AI Design Engineer application.
// Edits on top of the master resume.content.js: the summary leads with the
// design+engineering hybrid background (Gaming & Animation coursework,
// illustration, Figma collaboration) this role is built around, and frames
// the i18n/tooling work honestly as systems-building experience rather than
// overclaiming formal design-system ownership. Projects are reordered to
// put the branding/marketing-site work first, since "build marketing
// landing pages" is a named responsibility. Job history and bullets are
// otherwise unchanged from the master.
...
module.exports = {
	...
	summary:
		'Senior Software Engineer with 14+ years of experience building, scaling, and modernizing web applications. I bridge design and engineering in a way most frontend specialists cannot: I started college with a Gaming & Animation emphasis before switching to Web Development, I still illustrate on my own time, and I have worked directly with designers in Figma. My React and TypeScript expertise is backed by ADA-accessible interface work at Overstock and systems-building experience, internationalization infrastructure and technical-debt tooling I built from scratch at Spiff. I also bring real B2B SaaS experience (Spiff, XANT) and marketing site design and development (Hoki Skateboards, Enspark). Joined Spiff as an early frontend engineer and stayed through its acquisition by Salesforce.',
