// Tailored ATS resume content for the theSeniorDev.com Frontend Developer
// application. One minimal, honest edit on top of the master
// resume.content.js: the summary leads with testing/TDD and architecture
// leadership, and adds the ed-tech-specific experience (Enspark's LMS and
// eLearning courses) that's directly on-theme for a company that builds a
// developer training platform, not just a bonus checkbox. Job history,
...
module.exports = {
	...
	summary:
		'Senior Software Engineer with 14+ years of experience building, scaling, and modernizing web applications. Frontend specialist in React and TypeScript with deep testing practice, TDD and Jest, and a track record of leading software architecture and standards across teams. My background also includes ed-tech platform engineering specifically: early in my career I rebuilt a Learning Management System and built interactive HR training courses, course delivery and progress tracking for a training platform. Joined Spiff as an early frontend engineer and stayed through its acquisition by Salesforce.',
