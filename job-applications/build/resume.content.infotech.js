// Tailored ATS resume content for the Infotech Sr. Front-End Engineer application.
// Edits on top of the master resume.content.js: the summary leads with
// accessibility depth (ADA compliance work at Overstock) and AI-assisted
// development, since the posting lists "AI-first / agentic development" as
// an expert-level must-have, not a nice-to-have. CI/CD ownership is called
// out explicitly since it's also a named requirement. Skills, jobs, and
// bullets are otherwise unchanged from the master.
...
module.exports = {
	...
	summary:
		'Senior Software Engineer with 14+ years of experience building, scaling, and modernizing web applications. Frontend specialist in React, TypeScript, and JavaScript, with accessibility work that went past checkbox compliance, including bringing user-generated-content templates into ADA compliance for a high-traffic national e-commerce site at Overstock. I pair daily with Claude Code and Cursor AI in production development, not as a novelty but as standard practice. I have also driven CI/CD and code-quality standards from the inside, expanding Jest coverage and establishing strict ESLint rule sets that drove company-wide TypeScript adoption at Salesforce. Joined Spiff as an early frontend engineer and stayed through its acquisition by Salesforce.',
