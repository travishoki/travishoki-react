// Tailored ATS resume content for the Linus Health Senior Full Stack
// Engineer I (React, Node.js) application. One minimal, honest edit on
// top of the master resume.content.js: the summary leads with React depth,
// the modern JS/TS tooling ecosystem named in the posting (Webpack, Vite,
// ESLint, Jest, Cypress), AI-assisted development with a validation
// discipline, real (if secondary) Node.js RESTful-service experience, and
// production React Native work, a named nice-to-have. Projects are
// reordered to put the React Native game first. No digital-health or
// regulated-environment experience is claimed, since none exists. Job
// history, bullets, skills, and education are unchanged from the master.
...
module.exports = {
	...
	summary:
		'Senior Software Engineer with 14+ years of experience building, scaling, and modernizing web applications. Frontend specialist in React with deep, current experience across the modern JavaScript/TypeScript tooling ecosystem: Webpack, Vite, ESLint, Jest, and Cypress. I bring real Node.js and Express experience building RESTful services and server-side rendering, and I use Claude Code and Cursor AI daily in production development, pairing AI-assisted speed with validation rather than skipping it. I also have production React Native experience, having designed, illustrated, and shipped a mobile game to both app stores. I mentor through pairing and have authored frontend architectural standards adopted across an entire engineering organization. Joined Spiff as an early frontend engineer and stayed through its acquisition by Salesforce.',
