// Tailored ATS resume content for the Planet Labs Senior Software Engineer,
// Front-end - D&I Solutions application. One minimal, honest edit on top
// of the master resume.content.js: the summary leads with REST API depth,
// state management (Redux), leading feature work discovery-through-
// deployment, mentoring, and daily production AI-tooling use, all named
// directly in this posting. No geospatial, mapping, or defense/
// intelligence experience is claimed, since none exists. Job history,
...
module.exports = {
	...
	summary:
		'Senior Software Engineer with 14+ years of experience building, scaling, and modernizing web applications. Frontend specialist in React and TypeScript with deep REST API integration experience and strong state management practice through Redux. I have a track record of leading feature work from discovery through deployment, and of mentoring engineers through pairing and code review. I authored the frontend architectural standards adopted across an entire engineering organization at XANT, and I architected internationalization infrastructure from scratch at Spiff. I also use Claude Code and Cursor AI daily in production development. Joined Spiff as an early frontend engineer and stayed through its acquisition by Salesforce.',
